...
from routes import student_router, default_router, headquarter_router, faculty_router, school_router,area_router, courses_teachers_router, tuition_router, school_headquarter_router
